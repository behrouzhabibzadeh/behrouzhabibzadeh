...
@Component({
selector: 'app-person-group-selector',
templateUrl: './person-group-selector.component.html',
styleUrls: ['./person-group-selector.component.css']
})
export class PersonGroupSelectorComponent implements OnInit {

@Output() selected = new EventEmitter<number>();
@Output() getDataComplete = new EventEmitter();
@Input() lable = 'گروه شخص';
...
ngOnInit() {
this.api.getActivePersonGroups()
 .subscribe(res => {
this.data = res;
