...
@Component({
selector: 'app-app-user-station-selector',
templateUrl: './app-user-station-selector.component.html',
styleUrls: ['./app-user-station-selector.component.css']
})
export class AppUserStationSelectorComponent implements OnInit {

@Output() selected = new EventEmitter<number>();
@Output() getDataComplete = new EventEmitter();
@Input() lable = 'ایستگاه کاربر';
...
ngOnInit() {
this.api.getActiveAppUserStations()
 .subscribe(res => {
this.data = res;
