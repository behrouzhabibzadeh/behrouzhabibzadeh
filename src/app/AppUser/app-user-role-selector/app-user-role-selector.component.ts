...
import {AppUserRole} from 'src/app/Models/AppUserRole';

@Component({
selector: 'app-app-user-role-selector',
templateUrl: './app-user-role-selector.component.html',
styleUrls: ['./app-user-role-selector.component.css']
})
export class AppUserRoleSelectorComponent implements OnInit {

@Output() selected = new EventEmitter<number>();
@Output() getDataComplete = new EventEmitter();
@Input() lable = 'نقش کاربر';
...
ngOnInit() {
this.api.getActiveAppUserRoles()
 .subscribe(res => {
this.data = res;
